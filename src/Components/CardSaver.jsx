...
export function CardSaver() {
  ...
  function Distance() {
    if(calculateDistance(card, user) > 100) {
      return(
        <h3 style={{display:"inline-block", borderStyle:"solid", background:"#4c6484", maxWidth:"300px", position:"absolute", top: '300px', left: '30px'}}>You are over 100 feet away from your card!</h3>
      );
    } else {
      return(
        <h1></h1>
